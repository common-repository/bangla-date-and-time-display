<?php
/*
Plugin Name: Bangla Date and Time Display
Plugin URI: http://www.ojobs.co.uk/
Description: This plugin will display all date, time and numbers of WordPress website into Bangla Language. Bangla date and time will be shown according to English calendar only. If you feel any problem with this plugin or want to make any query then please visit the website of <a href=http://www.ojobs.co.uk/>oJobs</a>. Feel free to contact with developer <a href=https://www.facebook.com/msisayeed>Abu Saeed Mohammad Sayem</a> in Facebook.
Version: 1.0
Author: Abu Saeed Mohammad Sayem
Author URI: http://profiles.wordpress.org/msisayeed
...
$bdat = '<meta name=\'bangla-date-and-time-display\' content=\'bangla-date-and-time-display-v1.0\' />';
